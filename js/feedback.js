...
class feedback {
    ...
    static playerSelectH() {
        f.playerSelectHandle(this);
    }

    static scenSelectH() {
        f.scenSelectHande(this);
    }

    // Might need to revise this to better suit form/text submissions.
    static feedbackH() {
